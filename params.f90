...
real:: fixed_delta = 2.e6 !time scale for damping (seconds)
real:: edge_frac_min = 0.875 !time scale for damping (seconds)
...
! Option for using different ocean flux paramterizations
!   = 36, COARE3.6 algorithm with cool skin computation, assumes ts is ocean bulk temperature
!   = 37, COARE3.6 algorithm, assumes input ts is skin temperature
!   = 0, SAM default CCM flux parameterization
integer :: ocean_flux_option = 0
