...
real tskinxy(nx,ny)	!  surface skin temperature xy-distribution (full value in K)
...
integer :: ncondavg, icondavg_cld, icondavg_cor, icondavg_cordn, &
     ...
     icondavg_sh_cloud, icondavg_sh_clear, icondavg_no_sh_cloud, &
     icondavg_no_sh_clear
